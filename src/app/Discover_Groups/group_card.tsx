    ...
    return (
        <MainPage>
            <div className='flex flex-col h-auto'>
                <div>
                    <img src={background.src} alt="Group background" className='w-[2000px] h-[390px] rounded-[35px]' />
                    <h6 className='w-[450px] h-[291px] font-normal text-[60px] text-[#1B1A1A] -mt-80 ml-8'>Find Your Group on Read Share</h6>
                    <h6 className='w-[399px] h-[46px] text-[30px] font-normal text-[#2C2C2C] mt-14 ml-4'>Featured Community</h6>
