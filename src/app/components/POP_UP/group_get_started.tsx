        ...
        <div className='w-[501px] h-auto bg-white mt-4 pl-8 pt-11 pb-14 pr-14 ml-3'>
            <div>
                ...
                <div className='flex flex-col gap-5 ml-2'>
                    <div className='w-[438px] h-[33px] font-normal text-[27px] text-[#343434] ml-4'>Welcome to joe’s Group</div>
                ...
                <div className='flex flex-col mt-9 gap-3'>
                    <div className='flex flex-row gap-4 rounded-[20px] w-[432px] h-[73px] border border-solid border-[#343434] p-6'>
                        ...
                        <div className=''>Get invitation link</div>
                        <div className='ml-28 -mt-1'><NavigateNextIcon /></div>
                    </div>
                    <div className='flex flex-row gap-4 rounded-[20px] w-[432px] h-[73px] border border-solid border-[#343434] p-6'>
                        <img src={profile.src} alt="logo" className='w-[50px] h-[50px] rounded-full -mt-4' />
                        <div className=''>Add your group’s Bio</div>
                        <div className='ml-[86px] -mt-1'><NavigateNextIcon /></div>
                    </div>
                    <div className='flex flex-row gap-4 rounded-[20px] w-[432px] h-[73px] border border-solid border-[#343434] p-6'>
                        <img src={profile.src} alt="logo" className='w-[50px] h-[50px] rounded-full -mt-4' />
                        <div className=''>Send your first message</div>
                        <div className='ml-[58px] -mt-1'><NavigateNextIcon /></div>
                    </div>
                </div>
            </div>
        </div>
